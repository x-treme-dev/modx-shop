<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Паста моющая универсальная "Мальва" 600 гр.',
    'longtitle' => 'Количество в упаковке 15 шт.',
    'description' => 'Моющее средство для стирки всех видов тканей вручную и в стиральных машинах.',
    'alias' => 'pasta-moyushhaya-malva',
    'alias_visible' => 1,
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    ...
    'parent' => 3,
    'isfolder' => 0,
    'introtext' => 'Универсальный гель для стирки Мальва (концентрат) - это современное высокоэффективное средство, предназначенное для стирки всех типов ткани вручную и в стиральных машинах в воде любой жесткости. По экономичности заменяет 2 стандартные пачки стирального порошка. Не вызывает аллергических реакций кожи рук. Высокоэффективен для удаления трудно выводимых пятен. Безопасен для любых видов тканей. Защищает стиральную машину от накипи. Продуктивен при температуре воды от +20С.',
    'content' => '<p>Таблица для оптовиков.</p>
<p> </p>
<p> </p>',
    'richtext' => 1,
    'template' => 3,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1683543841,
    'editedby' => 1,
    'editedon' => 1687359196,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1683543840,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'katalog/pastyi-moyushhie/pasta-moyushhaya-malva.html',
    'uri_override' => 0,
    ...
    'old_price' => 0.0,
    'weight' => 0.6,
    'image' => '/assets/images/products/4/malva-1.jpg',
    'thumb' => '/assets/images/products/4/big/malva-1.jpg',
    'vendor' => 1,
    'made_in' => '',
    'new' => 1,
    'popular' => 1,
...
<li class="breadcrumb-item" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="katalog/pastyi-moyushhie/"><span itemprop="name">Пасты моющие</span></a></li>
<li class="breadcrumb-item current" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="katalog/pastyi-moyushhie/pasta-moyushhaya-malva.html"><span itemprop="name">Паста моющая универсальная "Мальва" 600 гр.</span></a></li></ul>
			<!--</div>-->
		  </div>
		</div>
	  </div>
	...
	<div class="row">
	  <div class="col-lg-6 col-md-6">
		<div class="product__details__pic">
		  <div id="msGallery">
            ...
            data-swipe="true"
            data-autoplay="5000">
                            <a href="/assets/images/products/4/malva-1.jpg" target="_blank">
                    <img src="/assets/images/products/4/small/malva-1.jpg" alt="" title="malva-1">
                </a>
                            <a href="/assets/images/products/4/malva-2.jpg" target="_blank">
                    <img src="/assets/images/products/4/small/malva-2.jpg" alt="" title="malva-2">
                </a>
                    </div>
    </div>
		</div>
	  ...
	  <div class="col-lg-6 col-md-6">
		<div class="product__details__text">
		  <h3>Паста моющая универсальная "Мальва" 600 гр.</h3>
		  ...
		  <div class="product__details__price">1 380 руб.</div>
		  <p>Количество в упаковке 15 шт.</p>
		  ...
		  <div class="product__details__quantity">
			<div class="quantity">
			  <div class="pro-qty">
				<input name="count" readonly="readonly" type="number" value="1">
			  </div>
			</div>
		  </div>

		  <button type="submit" name="ms2_action" value="cart/add" class="primary-btn">В корзину</button>
		  <a href="#" class="heart-icon"><span class="icon_heart_alt"></span></a>
         </form>
		  <ul>
			<li><b>Наличие</b> <span>много</span></li>
			<li><b>Доставка</b> <span>от 1 рабочего дня</span></li>
			<li><b>Вес 1 ед. товара</b> <span>0.6 кг.</span></li>
			<li><b>Производство</b> <span>ООО АИР "Открытие"</span></li>
			<!--<li><b>Share on</b>
			  <div class="share">
				<a href="#"><i class="fa fa-facebook"></i></a>
				<a href="#"><i class="fa fa-twitter"></i></a>
		...
		<div class="product__details__tab">
		  <ul class="nav nav-tabs" role="tablist">
			...
			<li class="nav-item">
			  ...
			  aria-selected="false">Опт</a>
			</li>
			<li class="nav-item">
			  <a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab"
			  aria-selected="false">Отзывы<span>(1)</span></a>
			</li>
		  </ul>
		  <div class="tab-content">
			<div class="tab-pane active" id="tabs-1" role="tabpanel">
			  <div class="product__details__tab__desc">
				...
				<p>Универсальный гель для стирки Мальва (концентрат) - это современное высокоэффективное средство, предназначенное для стирки всех типов ткани вручную и в стиральных машинах в воде любой жесткости. По экономичности заменяет 2 стандартные пачки стирального порошка. Не вызывает аллергических реакций кожи рук. Высокоэффективен для удаления трудно выводимых пятен. Безопасен для любых видов тканей. Защищает стиральную машину от накипи. Продуктивен при температуре воды от +20С.</p>
			  </div>
			</div>
			<div class="tab-pane" id="tabs-2" role="tabpanel">
			  <div class="product__details__tab__desc">
				<!--<h6>Products Infomation</h6>-->
				<p><p>Таблица для оптовиков.</p>
<p> </p>
<p> </p></p>
			  </div>
			</div>
...
<li class="breadcrumb-item current" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="katalog/pastyi-moyushhie/pasta-moyushhaya-malva.html"><span itemprop="name">Паста моющая универсальная "Мальва" 600 гр.</span></a></li></ul>
    ...
    '[[$headerProduct]]' => '<section class="product-details spad">
  <div class="container">
	<div class="row">
	  <div class="col-lg-6 col-md-6">
		<div class="product__details__pic">
	...
	<div class="container">
      ...
      array (
        ...
        array (
          ...
          'category' => 10,
          'cache_type' => 0,
          'snippet' => '<section class="product-details spad">
  <div class="container">
	<div class="row">
	  <div class="col-lg-6 col-md-6">
		<div class="product__details__pic">
	  ...
	  <div class="col-lg-6 col-md-6">
		<div class="product__details__text">
		  ...
		  <div class="product__details__price">[[+price]] руб.</div>
		  <p>[[*longtitle]]</p>
          <form class="form-horizontal ms2_form" method="post">
		  ...
		  <ul>
			<li><b>Наличие</b> <span>много</span></li>
			<li><b>Доставка</b> <span>от 1 рабочего дня</span></li>
			<li><b>Вес 1 ед. товара</b> <span>[[+weight]] кг.</span></li>
			<li><b>Производство</b> <span>[[+vendor.name]]</span></li>
			<!--<li><b>Share on</b>
			  <div class="share">
				<a href="#"><i class="fa fa-facebook"></i></a>
				<a href="#"><i class="fa fa-twitter"></i></a>
	...
	<div class="row">
	  ...
	  <div class="col-lg-3 col-md-4 col-sm-6">
		<div class="product__item">
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="product-details spad">
  <div class="container">
	<div class="row">
	  <div class="col-lg-6 col-md-6">
		<div class="product__details__pic">
