<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Гели для стирки',
    'longtitle' => '',
    'description' => '',
    'alias' => 'geli-dlya-stirki',
    'alias_visible' => 1,
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1685988986,
    'editedby' => 1,
    'editedon' => 1685991208,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1685988960,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<section class="hero hero-normal">
  ...
  <!-- Breadcrumb Section Begin -->
   <section class="breadcrumb-section set-bg" data-setbg="assets/img/bg-pattern-3.png">
	<div class="container">
	  <div class="row">
		<div class="col-lg-12 text-center">
		  <div class="breadcrumb__text">
			...
			<!--<div class="breadcrumb__option">-->
			  ...
			  <span>Shop</span>-->
			  <ul itemscope itemtype="http://shema.org/BreadcrumbList"><li class="breadcrumb-item" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="/"><span itemprop="name">Главная</span></a></li>
...
<li class="breadcrumb-item current" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="katalog/geli-dlya-stirki/"><span itemprop="name">Гели для стирки</span></a></li></ul>
			<!--</div>-->
		  </div>
		</div>
	  </div>
	  ...
	  <div class="col-lg-3 col-md-5">
		<div class="sidebar">
		  <div class="sidebar__item">
			<h4>Ассортимент</h4>
			<ul>
			  <li><a href="katalog/pastyi-moyushhie/">Пасты моющие</a></li>
			  <li><a href="#">Пасты чистящие</a></li>
			  <li><a href="#">Гели для стрирки</a></li>
			  <li><a href="#">Шампунь</a></li>
			  <li><a href="#">Бумага гигиеническая</a></li>
			</ul>
		  </div>
...
<section class="hero hero-normal">
  <div class="container">
    ...
    '[[pdoCrumbs?
			  &showHome = `1`
			  &tplWrapper=`crumbWrapperTpl`
			  &tplCurrent=`crumbCurrentTpl`
			  &tpl=`crumbTpl`
			  ]]' => '<ul itemscope itemtype="http://shema.org/BreadcrumbList"><li class="breadcrumb-item" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="/"><span itemprop="name">Главная</span></a></li>
<li class="breadcrumb-item" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="katalog/"><span itemprop="name">Каталог</span></a></li>
<li class="breadcrumb-item current" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="katalog/geli-dlya-stirki/"><span itemprop="name">Гели для стирки</span></a></li></ul>',
    '[[$breadcrumbs]]' => ' <section class="breadcrumb-section set-bg" data-setbg="assets/img/bg-pattern-3.png">
	<div class="container">
	  <div class="row">
		<div class="col-lg-12 text-center">
		  <div class="breadcrumb__text">
...
<li class="breadcrumb-item current" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="katalog/geli-dlya-stirki/"><span itemprop="name">Гели для стирки</span></a></li></ul>
    ...
    '[[$headerInner]]' => '<section class="product spad">
  <div class="container">
	<div class="row">
	  <div class="col-lg-3 col-md-5">
		<div class="sidebar">
...
<script src="assets/js/owl.carousel.min.js"></script>
<script src="assets/js/main.js"></script>',
    '[[msProducts?tpl=`gridProductTpl`&limit=`12`&offset=`0`&depth=`10`&sortby=`id`&sortbyOptions=``&sortdir=`ASC`&toPlaceholder=``&toSeparatePlaceholders=``&showLog=``&parents=``&resources=``&includeContent=``&includeTVs=``&includeThumbs=``&optionFilters=``&where=``&link=``&master=``&slave=``&tvPrefix=``&outputSeparator=`
`&returnIds=``&return=`data`&showUnpublished=``&showDeleted=``&showHidden=`1`&showZeroPrice=`1`&wrapIfEmpty=`1`&plPrefix=``&maxLimit=`100`&page=`1`&pageVarKey=`page`&totalVar=`page.total`&pageLimit=`5`&element=`msProducts`&pageNavVar=`page.nav`&pageCountVar=`pageCount`&pageLinkScheme=``&tplPage=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">[[+pageNo]]</a></li>`&tplPageWrapper=`@INLINE <ul class="pagination">[[+first]][[+prev]][[+pages]][[+next]][[+last]]</ul>`&tplPageActive=`@INLINE <li class="page-item active"><a class="page-link" href="[[+href]]">[[+pageNo]]</a></li>`&tplPageFirst=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">[[%pdopage_first]]</a></li>`&tplPageLast=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">[[%pdopage_last]]</a></li>`&tplPagePrev=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">&laquo;</a></li>`&tplPageNext=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">&raquo;</a></li>`&tplPageSkip=`@INLINE <li class="page-item disabled"><span class="page-link">...</span></li>`&tplPageFirstEmpty=`@INLINE <li class="page-item disabled"><span class="page-link">[[%pdopage_first]]</span></li>`&tplPageLastEmpty=`@INLINE <li class="page-item disabled"><span class="page-link">[[%pdopage_last]]</span></li>`&tplPagePrevEmpty=`@INLINE <li class="page-item disabled"><span class="page-link">&laquo;</span></li>`&tplPageNextEmpty=`@INLINE <li class="page-item disabled"><span class="page-link" >&raquo;</span></li>`&cache=``&cacheTime=`3600`&cacheAnonymous=``&ajax=``&ajaxMode=``&ajaxElemWrapper=`#pdopage`&ajaxElemRows=`#pdopage .rows`&ajaxElemPagination=`#pdopage .pagination`&ajaxElemLink=`#pdopage .pagination a`&ajaxElemMore=`#pdopage .btn-more`&ajaxTplMore=`@INLINE <button class="btn btn-primary btn-more">[[%pdopage_more]]</button>`&ajaxHistory=``&setMeta=`1`&strictMode=`1`&request=`a890f5d6a76ac6fa8836d7907fb6c085`&setTotal=`1`]]' => '<div class="col-lg-4 col-md-6 col-sm-6">
<div class="product__item"  class="row ms2_product">
  <form method="post" class="ms2_form">
	<input type="hidden" name="id" value="9">
	<input type="hidden" name="count" value="1">
	<input type="hidden" name="options" value="[]">
	<div class="product__item__pic set-bg">
	  	  <img src="/assets/images/products/9/-1.jpg" style="width:240px; height:270px;" alt="Гель для стирки универсальный "Мальва" 950 гр." title="Гель для стирки универсальный "Мальва" 950 гр."/>
	...
	<div class="product__item__text">
	  <h6><a href="katalog/geli-dlya-stirki/gel-dlya-stirki-universalnyij-malva-950-gr.html">Гель для стирки универсальный "Мальва" 950 гр.</a></h6>
	  <h5> 872 руб.</h5>
	</div>
  </form>
</div>
...
<div class="product__item"  class="row ms2_product">
  <form method="post" class="ms2_form">
	...
	<input type="hidden" name="options" value="[]">
	<div class="product__item__pic set-bg">
	  	  <img src="/assets/images/products/13/gel-styrka-1.1.png" style="width:240px; height:270px;" alt="Гель для стирки цветных тканей "Лаванда" 1.1 кг" title="Гель для стирки цветных тканей "Лаванда" 1.1 кг"/>
	...
	<div class="product__item__text">
	  <h6><a href="katalog/geli-dlya-stirki/gel-dlya-stirki-lavanda-dlya-czvetnyix-tkanej-1.1-kg.html">Гель для стирки цветных тканей "Лаванда" 1.1 кг</a></h6>
	  <h5> 736 руб.</h5>
	</div>
  </form>
</div>
...
<div class="product__item"  class="row ms2_product">
  <form method="post" class="ms2_form">
	...
	<input type="hidden" name="options" value="[]">
	<div class="product__item__pic set-bg">
	  	  <img src="/assets/images/products/14/gel-detscoe.png" style="width:240px; height:270px;" alt="Гель для стирки детского белья "Лаванда" 1.1 кг" title="Гель для стирки детского белья "Лаванда" 1.1 кг"/>
	...
	<div class="product__item__text">
	  <h6><a href="katalog/geli-dlya-stirki/gel-dlya-stirki-lavanda-dlya-detskogo-belya-1.1-kg.html">Гель для стирки детского белья "Лаванда" 1.1 кг</a></h6>
	  <h5> 736 руб.</h5>
	</div>
  </form>
</div>
...
<div class="product__item"  class="row ms2_product">
  <form method="post" class="ms2_form">
	...
	<input type="hidden" name="options" value="[]">
	<div class="product__item__pic set-bg">
	  	  <img src="/assets/images/products/15/gel-svetly.png" style="width:240px; height:270px;" alt="Гель для стирки белых и светлых тканей "Лаванда"1.1 кг" title="Гель для стирки белых и светлых тканей "Лаванда"1.1 кг"/>
	...
	<div class="product__item__text">
	  <h6><a href="katalog/geli-dlya-stirki/gel-dlya-stirki-belyix-i-svetlyix-tkanej-lavanda1.1-kg.html">Гель для стирки белых и светлых тканей "Лаванда"1.1 кг</a></h6>
	  <h5> 736 руб.</h5>
	</div>
  </form>
</div>
...
<div class="product__item"  class="row ms2_product">
  <form method="post" class="ms2_form">
	...
	<input type="hidden" name="options" value="[]">
	<div class="product__item__pic set-bg">
	  	  <img src="/assets/images/products/16/gel-univers-1.png" style="width:240px; height:270px;" alt="Гель для стирки универсальный "Лаванда" 1.1 кг" title="Гель для стирки универсальный "Лаванда" 1.1 кг"/>
	...
	<div class="product__item__text">
	  <h6><a href="katalog/geli-dlya-stirki/gel-dlya-stirki-universalnyij-lavanda-1.1-kg.html">Гель для стирки универсальный "Лаванда" 1.1 кг</a></h6>
	  <h5> 736 руб.</h5>
	</div>
  </form>
</div>
...
<div class="product__item"  class="row ms2_product">
  <form method="post" class="ms2_form">
	...
	<input type="hidden" name="options" value="[]">
	<div class="product__item__pic set-bg">
	  	  <img src="/assets/images/products/17/gel-temn.png" style="width:240px; height:270px;" alt="Гель для стирки тёмных и чёрных тканей "Лаванда" 1.1 кг" title="Гель для стирки тёмных и чёрных тканей "Лаванда" 1.1 кг"/>
	...
	<div class="product__item__text">
	  <h6><a href="katalog/geli-dlya-stirki/gel-dlya-stirki-tyomnyix-i-chyornyix-tkanej-lavanda-1.1-kg.html">Гель для стирки тёмных и чёрных тканей "Лаванда" 1.1 кг</a></h6>
	  <h5> 736 руб.</h5>
	</div>
  </form>
</div>
...
<div class="product__item"  class="row ms2_product">
  <form method="post" class="ms2_form">
	...
	<input type="hidden" name="options" value="[]">
	<div class="product__item__pic set-bg">
	  	  <img src="/assets/images/products/18/get-uni-1.png" style="width:240px; height:270px;" alt="Гель для стирки универсальный "Лаванда" 2.4 кг" title="Гель для стирки универсальный "Лаванда" 2.4 кг"/>
	...
	<div class="product__item__text">
	  <h6><a href="katalog/geli-dlya-stirki/gel-dlya-stirki-universalnyij-lavanda-2.4-kg.html">Гель для стирки универсальный "Лаванда" 2.4 кг</a></h6>
	  <h5> 680 руб.</h5>
	</div>
  </form>
</div>
...
<link rel="stylesheet" href="assets/css/style.css" type="text/css">',
      ...
      array (
        ...
        array (
          ...
          'property_preprocess' => false,
          'name' => 'top-secondary',
          'description' => 'Чанк верхней части второстепенных страниц сайта. Отличается тем, что нет баннера под поиском.',
          'editor_type' => 0,
          'category' => 10,
          'cache_type' => 0,
          'snippet' => '<div id="preloder">
  <div class="loader"></div>
</div>
	...
	<div class="row">
      ...
      array (
        ...
        array (
          ...
          'category' => 10,
          'cache_type' => 0,
          'snippet' => ' <section class="breadcrumb-section set-bg" data-setbg="assets/img/bg-pattern-3.png">
	<div class="container">
	  <div class="row">
		<div class="col-lg-12 text-center">
		  <div class="breadcrumb__text">
          ...
          'static' => false,
          'static_file' => '',
          'content' => ' <section class="breadcrumb-section set-bg" data-setbg="assets/img/bg-pattern-3.png">
	<div class="container">
	  <div class="row">
		<div class="col-lg-12 text-center">
		  <div class="breadcrumb__text">
      ...
      array (
        ...
        array (
          ...
          'property_preprocess' => false,
          'name' => 'headerInner',
          'description' => 'Чанк с товарами в шаблоне Каталог товаров',
          'editor_type' => 0,
          'category' => 10,
          'cache_type' => 0,
          'snippet' => '<section class="product spad">
  <div class="container">
	<div class="row">
	  <div class="col-lg-3 col-md-5">
		<div class="sidebar">
	  ...
	  <div class="col-lg-9 col-md-7">
		...
		<div class="product__pagination">
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<section class="product spad">
  <div class="container">
	<div class="row">
	  <div class="col-lg-3 col-md-5">
		<div class="sidebar">
