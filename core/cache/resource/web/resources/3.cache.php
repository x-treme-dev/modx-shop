<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Пасты моющие',
    'longtitle' => '',
    'description' => '',
    'alias' => 'pastyi-moyushhie',
    'alias_visible' => 1,
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1683542998,
    'editedby' => 0,
    'editedon' => 0,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1683542998,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<li class="breadcrumb-item current" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="katalog/pastyi-moyushhie/"><span itemprop="name">Пасты моющие</span></a></li></ul>
			<!--</div>-->
		  </div>
		</div>
	  </div>
...
<div class="product__item"  class="row ms2_product">
  <form method="post" class="ms2_form">
	...
	<div class="product__item__pic set-bg">
	  	  <img src="/assets/images/products/4/malva-1.jpg" style="width:240px; height:270px;" alt="Паста моющая универсальная "Мальва" 600 гр." title="Паста моющая универсальная "Мальва" 600 гр."/>
	...
	<div class="product__item__text">
	  <h6><a href="katalog/pastyi-moyushhie/pasta-moyushhaya-malva.html">Паста моющая универсальная "Мальва" 600 гр.</a></h6>
	  <h5> 1 380 руб.</h5>
	</div>
  </form>
</div>
...
<div class="product__item"  class="row ms2_product">
  <form method="post" class="ms2_form">
	...
	<input type="hidden" name="options" value="[]">
	<div class="product__item__pic set-bg">
	  	  <img src="/assets/images/products/10/pasta.png" style="width:240px; height:270px;" alt="Паста моющая универсальная "Мальва" 500 гр." title="Паста моющая универсальная "Мальва" 500 гр."/>
	...
	<div class="product__item__text">
	  <h6><a href="katalog/pastyi-moyushhie/pasta-moyushhaya-universalnaya-malva-500-gr.html">Паста моющая универсальная "Мальва" 500 гр.</a></h6>
	  <h5> 1 968 руб.</h5>
	</div>
  </form>
</div>
